#!/usr/bin/env python3
"""티머니 STIS 택시 데이터 13개 테이블 목데이터 생성 (100x scale)"""
...
def gen_d012(total=1000000, chunk_size=100000):
...
def gen_h002(total=3000000, chunk_size=500000):
